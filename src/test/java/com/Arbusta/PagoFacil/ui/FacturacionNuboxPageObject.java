...
public class FacturacionNuboxPageObject {
	...
	public static Target txt_RUT_Contraparte = Target.the("el campo 'RUT Contraparte'").located(By.id("rutContraparte"));
	...
	public static Target txt_Razon_Social_contraparte = Target.the("el campo 'Razon Social contraparte'").located(By.id("razonSocialContraparte"));
	...
	public static Target txt_Comuna_contraparte = Target.the("el campo 'Comuna contraparte'").located(By.id("comunaContraparte"));
	...
	public static Target txt_Folio = Target.the("el campo 'Folio'").located(By.id("folio"));
	
	public static Target txt_Codigo_de_sucursal = Target.the("el campo 'Codigo de sucursal'").located(By.id("codigoSucursal"));
	...
	public static Target txt_Dirección_contraparte = Target.the("el campo 'Dirección contraparte'").located(By.id("direccionContraparte"));
	...
	public static Target cal_Fecha_desde = Target.the("el campo 'Fecha desde'").located(By.id("fechaPeriodoDesde"));
	...
	public static Target cal_Fecha_hasta = Target.the("el campo 'Fecha hasta'").located(By.id("fechaPeriodoHasta"));
	...
	public static Target sel_Tipo_de_factura = Target.the("el campo 'Tipo de factura'").located(By.id("type"));
	
	public static Target cal_Fecha = Target.the("el campo 'Fercha'").located(By.id("fecha"));
	...
	public static Target cal_Fecha_de_Vencimiento = Target.the("el campo 'Fercha de Vencimiento'").located(By.id("fechaVencimiento"));
	...
	public static Target txt_NOMBRE = Target.the("el campo 'NOMBRE'").located(By.id("producto"));
	...
	public static Target txt_CANTIDAD = Target.the("el campo 'CANTIDAD'").located(By.id("cantidad"));
	...
	public static Target txt_PRECIO = Target.the("el campo 'PRECIO'").located(By.id("valor"));
	...
	public static Target txt_DESCRIPCIÓN = Target.the("el campo 'DESCRIPCIÓN'").located(By.id("descripcion"));
